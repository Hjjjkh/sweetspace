...
export default function Layout() {
  ...
  return (
    <>
      {/* 侧边导航栏 (桌面端) - 固定在页面左侧 */}
      <nav className="hidden sm:flex fixed left-4 top-1/2 -translate-y-1/2 bg-white/70 backdrop-blur-glass border border-rose-border rounded-2xl shadow-glass p-2 space-y-1 z-50">
        {navItems.map((item) => {
      ...
      {/* 主内容区 */}
      <div className="min-h-screen bg-romantic-gradient sm:ml-20">
        {/* 背景装饰 */}
        ...
        {/* 顶部导航栏 */}
        <header className="relative bg-white/70 backdrop-blur-glass border-b border-rose-border shadow-glass sticky top-0 z-40">
